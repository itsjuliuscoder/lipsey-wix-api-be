 ...
 * @applicableIdentity APP
 */
export async function updateProductVariants(_id, variants) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function resetAllProductVariantData(_id) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({ id: _id });
 ...
 * @applicableIdentity APP
 */
export async function addProductsToCollection(_id, productIds) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function removeProductsFromCollection(_id, productIds) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function addProductMedia(_id, media) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function removeProductMedia(_id, mediaIds) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function addProductMediaToChoices(_id, media) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function removeProductMediaFromChoices(_id, media) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity APP
 */
export async function deleteProductOptions(_id) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({ id: _id });
 ...
 * @applicableIdentity APP
 */
export async function removeBrand(_id) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({ id: _id });
 ...
 * @applicableIdentity APP
 */
export async function updateCollection(_id, collection) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
 ...
 * @applicableIdentity APP
 */
export async function removeRibbon(_id) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({ id: _id });
 ...
 * @applicableIdentity APP
 */
export async function bulkUpdateProductsProperty(ids, set) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
 ...
 * @applicableIdentity APP
 */
export async function bulkAdjustProductProperty(adjust, ids) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        adjust: adjust,
 ...
 * @applicableIdentity VISITOR
 */
export async function getProduct(_id, options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity VISITOR
 */
export async function getProductOptionsAvailability(_id, options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity VISITOR
 */
export async function queryProductVariants(_id, options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        id: _id,
 ...
 * @applicableIdentity VISITOR
 */
export async function queryStoreVariants(query) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
 ...
 * @applicableIdentity VISITOR
 */
export async function getStoreVariant(_id) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({ id: _id });
