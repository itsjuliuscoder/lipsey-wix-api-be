...
const PACKAGE_NAME = '@wix/stores_info-sections-v-3';
/**
 ...
 */
export function createInfoSection(payload) {
...
export function getInfoSection(payload) {
 ...
 */
export function getOrCreateInfoSection(payload) {
 ...
 * > **Note:** If an info section with the passed `uniqueName` doesn't exist, the `uniqueName` and `title` fields are required to create a new info section.
 */
export function bulkGetOrCreateInfoSections(payload) {
 ...
 */
export function updateInfoSection(payload) {
 ...
 */
export function deleteInfoSection(payload) {
 ...
 */
export function queryInfoSections(payload) {
...
export function bulkCreateInfoSections(payload) {
 ...
 * This ensures you're working with the latest info section and prevents unintended overwrites.
 */
export function bulkUpdateInfoSections(payload) {
...
export function bulkDeleteInfoSections(payload) {
