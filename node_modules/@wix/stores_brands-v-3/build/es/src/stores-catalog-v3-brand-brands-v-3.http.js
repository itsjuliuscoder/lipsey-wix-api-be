...
const PACKAGE_NAME = '@wix/stores_brands-v-3';
/**
 * Creates a brand.
 *
 ...
 */
export function queryBrands(payload) {
...
export function bulkCreateBrands(payload) {
 ...
 * This ensures you're working with the latest brand and prevents unintended overwrites.
 */
export function bulkUpdateBrands(payload) {
...
export function getOrCreateBrand(payload) {
...
export function bulkGetOrCreateBrands(payload) {
...
export function bulkDeleteBrands(payload) {
