...
const PACKAGE_NAME = '@wix/stores_stores-locations-v-3';
/** Retrieves a Stores location. */
export function getStoresLocation(payload) {
 ...
 */
export function queryStoresLocations(payload) {
...
//# sourceMappingURL=stores-catalog-v3-stores-location-stores-locations-v-3.http.js.map